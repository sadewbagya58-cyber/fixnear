    ...
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400">Log in to manage your professional profile.</p>
        </div>
        ...
        <form className="space-y-4">
          ...
          <button
            formAction={login}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 rounded-xl transition-all active:scale-[0.98] mt-2 shadow-lg shadow-blue-900/20"
          >
            Log In
          </button>
        </form>
        ...
        <p className="mt-8 text-center text-slate-500 text-sm">
          ...
          <Link href="/signup" className="text-blue-500 font-semibold hover:underline">Sign up for free</Link>
        </p>
      </div>
    </div>
  )
